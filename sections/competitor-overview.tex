...
%The features are based upon the common features and functionalities that are seen in the different systems. The list of response systems is based on our own research. 
The systems mentioned here covers the majority of the response systems that are available today. % and most of them are commercially available.
...
All the following CRSs will be analysed with these features taken into consideration. %A summary can be seen in table \ref{tab:overview}.
...
%Even though this is not part of our definition for code support, it is one of the features that we find relevant to expand on.
