...
All forces must be taken into consideration when evaluating the strategic position to ensure our system's survival in a challenging market.
...
%An important notice is, that there are plenty of fully digital CRSs available. The ones that we mention here is merely the ones that we were able to find during our research. Arguably there might be more, but we will only be concerned about the ones mentioned here. 
...
A substitute is a product, that serves the same or similar purpose as the original product, but by different means \cite[p.~84]{porter2008five}. Some of \citeA{porter2008five}'s own examples are videoconferencing that is a substitute for travel and e-mail that is a substitute for regular mail. A CRS could in fact itself be a substitute, where hand raising and asking questions would be substituted by a CRS. 
